...
SETTINGS = (
    ...
    research("expert-pool-gb", "FLASHNEXT_EXPERT_POOL_GB", "6", "startup", float, unset="0"),
    ...
    research("ngram-parallel-min", "FLASHNEXT_NGRAM_PARALLEL_MIN", "16", "startup", integer, unset="0"),
