...
SETTINGS = (
    ...
    research("coalesce-min-rows", "FLASHNEXT_COALESCE_MIN_ROWS", "32", "startup", integer),
    research("coalesce-tasks", "FLASHNEXT_COALESCE_TASKS", "16", "startup", integer),
    research("prefill-pipeline", "FLASHNEXT_PREFILL_PIPELINE", parser=choice(("0", "1"), "prefill-pipeline")),
    research("prefill-pipeline-chunks", "FLASHNEXT_PREFILL_PIPELINE_CHUNKS", "4", "startup", integer),
    research("prefill-pipeline-min", "FLASHNEXT_PREFILL_PIPELINE_MIN", "32", "startup", integer),
    research("compile-hc", "FLASHNEXT_COMPILE_HC", parser=choice(("0", "1"), "compile-hc")),
    research("stream-embed", "FLASHNEXT_STREAM_EMBED", "0", "startup", choice(("0", "1"), "stream-embed")),
    research("ngram-parallel-min", "FLASHNEXT_NGRAM_PARALLEL_MIN", "0", "startup", integer),
    research("io-qos", "FLASHNEXT_IO_QOS", "default", "startup", choice(("default", "user-interactive", "user-initiated", "utility"), "io-qos")),
