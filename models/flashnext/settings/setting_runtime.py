...
SETTINGS = (
    ...
    Setting("stream-pack", ("FLASHNEXT_STREAM_PACK",), "1", str, "startup", "storage", "public", "flashnext", env_reader("FLASHNEXT_STREAM_PACK", "0"), None, lambda _b: True, None, "FLASHNEXT_STREAM_PACK", __file__),
    ...
    Setting("io-workers", ("FLASHNEXT_IO_WORKERS",), 8, integer, "startup", "storage", "public", "flashnext", env_reader("FLASHNEXT_IO_WORKERS", 16, integer), None, lambda _b: True, None, "FLASHNEXT_IO_WORKERS", __file__),
