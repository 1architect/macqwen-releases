...
from models.flashnext.tests.bench import bench_production as bench
from models.flashnext.tests.bench.bench_production import (
    arm,
...
class ConditionTests(unittest.TestCase):
    ...
    def test_q4_g64_is_rejected_for_generic_runtime_comparison(self):
        with patch(
            "models.flashnext.tests.bench.bench_chat_parity.checkpoint_runtime_capability",
    ...
    def test_arm_publishes_measurements_before_runtime_validation(self):
        ...
        for g64 in (False, True):
            ...
            with self.subTest(g64=g64), patch(
                ...
                "models.flashnext.tests.bench.bench_production.apply_condition",
            ), patch.object(
    ...
    def test_benchmark_provenance_is_checkpoint_and_runtime_bound(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "models.flashnext.tests.bench.bench_chat_parity.source_fingerprint",
                return_value="runtime-a",
            ), patch(
                "models.flashnext.slab_pack.checkpoint_identity",
                return_value="checkpoint-a",
            ), patch(
                "models.flashnext.tests.bench.bench_production.benchmark_harness_fingerprint",
