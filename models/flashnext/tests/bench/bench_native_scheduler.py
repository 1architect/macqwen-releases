...
def run_moe_benchmark(args, strategies: tuple[str, ...]) -> int:
    ...
    from models.flashnext.tests.bench.metal_native import probe_native, run_native_moe, init_native_moe
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        from models.flashnext.tests.bench.metal_native import probe_native, run_dependency_chain
