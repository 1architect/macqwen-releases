...
Usage:
    python -m models.flashnext.tests.bench.slab_status --model ~/models/CHECKPOINT
...
def summarize_slab(store, switch_modules) -> dict:
    ...
    from models.flashnext.routing import pin_profile_compatible, checkpoint_identity_for_store
    from models.flashnext.slab_pack import validate_slab_allocation
